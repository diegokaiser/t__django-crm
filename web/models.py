...
class Brand(models.Model):
    ...
    logo = models.FileField(
        upload_to='static/src/images/brands/logos', validators=[FileExtensionValidator(['jpg', 'jpeg', 'png', 'svg'])]
    )
...
class Reason(models.Model):
    ...
    icon = models.FileField(
        upload_to='static/src/images/reasons/icons', validators=[FileExtensionValidator(['jpg', 'jpeg', 'png', 'svg'])]
    )
    created_at = models.DateTimeField(auto_now_add=True)
...
class BannerDestacado(models.Model):
    image = models.ImageField(upload_to='static/src/images/banners/destacado')
    background = models.ImageField(upload_to='static/src/images/banners/destacado')
...
class BannerA(models.Model):
    image = models.ImageField(upload_to='static/src/images/banners/a')
    background = models.ImageField(upload_to='static/src/images/banners/a')
    title = models.CharField(max_length=70)
    description = models.TextField()
    link_title = models.CharField(max_length=70)
    link = models.TextField()
...
class Product(models.Model):
    ...
    picture = models.ImageField(upload_to='static/src/images/products/pictures', null=True, blank=True)
    description = models.TextField()
    ...
    line = models.SmallIntegerField(default=0)
    created_at = models.DateTimeField(auto_now_add=True)
