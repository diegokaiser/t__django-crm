const app=[]
app.home={init:()=>{console.log(':)')},search:()=>{const onClickSearchByProduct=document.querySelector('.js-searchByProduct')
...
onClickSearchByProduct.addEventListener('click',(event)=>{this.classList.add('active')
...
onClickSearchByKeyword.addEventListener('click',(event)=>{this.classList.add('active')
...
window.addEventListener('load',()=>{app.home.init()
app.home.search()});